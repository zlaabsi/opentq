...
- [ ] Phase 0: Preflight repo state, disk headroom, llama.cpp binaries, and focused tests.
- [ ] Phase 1: Refresh artifact audit, M1 Max 32GB runtime gates, canonical GGUF staging, and naming checks.
- [ ] Phase 2: Re-run deterministic OTQ micro-evals and rebuild GGUF benchmark plots/CSVs.
